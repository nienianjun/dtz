...
namespace DTZ.Helper
{
    ...
    public class StrHelper
    {
        ...
        public static bool InArray(string str, string stringarray)
        {
            return InArray(str, Split(stringarray, ","), false);
        }
        /// <summary>
        /// 判断指定字符串是否属于指定字符串数组中的一个元素
        /// </summary>
        ...
        {
            return InArray(str, Split(stringarray, strsplit), caseInsensetive);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string[] Split(string strContent, string strSplit, int p_3)
        {
            string[] result = new string[p_3];

            string[] splited = Split(strContent, strSplit);
        ...
        /// </summary>
        /// <param name="str"></param>
        /// <param name="bantext">有多个脏字的用﹠符号隔开</param>
        /// <returns></returns>
        public static string StrFilter(string str, string bantext)
        {
            string text1 = "";
            string text2 = "";
            string[] textArray1 = Split(bantext, "&");
        ...
        public static string[] GetRegexValue(string xml, string regex)
        {
